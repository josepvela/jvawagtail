# flake8: noqa
"""
Django settings for jvawagtail project.
...
DJANGO_ROOT = root.path('jvawagtail')
...
WSGI_APPLICATION = 'jvawagtail.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///jvawagtail'),
}
